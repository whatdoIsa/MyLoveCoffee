...
export async function loader() {
  return json({
    mapKey: "335c3ba3c88eba30546719a5d60f0c08",
  });
}
      ...
      <body>
        {mapKey && (
          <script
            ...
            src={`//dapi.kakao.com/v2/maps/sdk.js?appkey=335c3ba3c88eba30546719a5d60f0c08&libraries=services,clusterer&autoload=false`}
          ></script>
        )}
        {children}
        <ScrollRestoration />
